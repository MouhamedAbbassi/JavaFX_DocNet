...
public class ListePatientController implements Initializable{
    ...
    ObservableList<user_user> list = service.getPatientListe(userSession.getUser().getId());
...
if (patient.getImage() == null) {
    imageView = new ImageView(new Image(("/resource/placeholder.jpg")));
} else {
    imageView = new ImageView(new Image(("file:///C:/xampp/htdocs/uploads/images/"+patient.getImage())));
}
        ...
        voirFicheBtn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                try {
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("afiicherFiche.fxml"));
                    Parent root = loader.load();
