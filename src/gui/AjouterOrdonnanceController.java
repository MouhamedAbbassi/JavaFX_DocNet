...
public class AjouterOrdonnanceController implements Initializable {
    ...
    public void initialize(int id, int patientId) throws SQLException {
        ...
        User doc = userService.findUser(userSession.getUser().getId());
    ...
    private void insertButton(ActionEvent event) throws IOException, InterruptedException {
        ...
        service.Inserer(o, ord, userSession.getUser().getId(), ordPatientId);
        ...
        Image img = new Image("/resource/tick1.png");
        ...
        try {
            Parent page1 = FXMLLoader.load(getClass().getResource("AfficherOrdonnance.fxml"));
            Scene scene = new Scene(page1);
            Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            stage.setScene(scene);
            stage.show();
        } catch (IOException ex) {
            Logger.getLogger(AjouterOrdonnanceController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void addForm(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("formRepeater.fxml"));
