...
public class AfficheOrdonnancePatientController implements Initializable {
    ...
    ObservableList<Ordonnance> list = service.getallOrdonnance(currentUserId);
    @FXML
    private VBox vbox;
    @FXML
    private Button ret;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        // Create a VBox to hold the information for each ordonnance
           ...
           String imagePath = "/uploads/dddd_cleanup.png";
    ...
    // Add the doctor's image
            ...
            {
                doctorImage = new ImageView(new Image(("/uploads/placeholder.jpg")));
            }else{
                doctorImage = new ImageView(new Image("/uploads/" + ordonnance.getDoctors().get(0).getImage()));
            }
