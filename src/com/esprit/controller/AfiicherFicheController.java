...
public class AfiicherFicheController {
     ...
     */
     ...
     public void initialize(int id) {
        ...
        userDoctor = userService.getDoctorInfo(currentUserId);
    ...
    private void createPdf(ActionEvent event) {
        try {
            ...
            File fontFile = new File("src/uploads/LufgaSemiBold.ttf");
            ...
            File fontFile1 = new File("src/uploads/drname.ttf");
            ...
            if (yReservation < 300) {
                contentStream.close();
                File imageFile1 = new File("src/uploads/pdfBackground.png");
                ...
                for (reservation reservation : res) {
                    ...
                    contentStream.showText(reservation.getDate());
                    contentStream.endText();
                    yReservation -= 30;
                    yNumR -= 30;
                    numReservation += 1;
